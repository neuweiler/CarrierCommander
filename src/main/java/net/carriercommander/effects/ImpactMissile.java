...
public class ImpactMissile extends Node {
	...
	private ParticleEmitter flash, spark, smoketrail, debris, shockwave;
	private float curTime = -1.0f;

	public ImpactMissile(AbstractState state) {
		this.state = state;
	...
	private void createSpark() {
		spark = new ParticleEmitter("Spark", ParticleMesh.Type.Triangle, 80);
		spark.setStartColor(new ColorRGBA(1f, 0.8f, 0.36f, 1.0f));
		spark.setEndColor(new ColorRGBA(1f, 0.8f, 0.36f, 0.3f));
